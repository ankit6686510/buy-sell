...
const Footer = () => {
    ...
    return (
        <Box
            component="footer"
            sx={{
                // Main Footer background: Primary Gradient, highly stylized
                ...
                <Box sx={{ py: 6 }}>
                    <GlassCard
                        sx={{
                            p: 4,
                            textAlign: 'center',
                            // Glass background using alpha(background.paper) with high opacity
                    ...
                    >
                        ...
                        >
                            <TextField
                                ...
                                variant="outlined"
                                // **MODERN STYLING REFINEMENT**
                                sx={{
                                    '& .MuiOutlinedInput-root': {
                                        borderRadius: 3,
                                        // Set a clear background for readability on the dark footer
                                        backgroundColor: alpha(theme.palette.common.white, 0.95),
                                        color: theme.palette.text.primary, // Ensure text is primary color (usually dark)
                                        '& fieldset': {
                                    ...
                                    '& input::placeholder': {
                                        ...
                                        opacity: 1, // Fix for chrome/safari opacity issue
                                    },
                                }}
                            />
                            <GradientButton
